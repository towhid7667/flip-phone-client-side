...
const Android = () => {
    ...
    return (
        <div className='w-10/12 mx-auto'>
            <div className='py-10 lg:h-screen flex flex-col justify-center items-center bg-cover bg-[url("https://cdn.pixabay.com/photo/2019/11/05/00/53/cellular-4602489_960_720.jpg")]'>
