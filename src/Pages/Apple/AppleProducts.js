...
const AppleProducts = () => {
    ...
    return (
        <div className='w-10/12 mx-auto  '>
            <div>
        <div className='py-10 lg:h-screen md:h-[300px] flex flex-col gap-3 justify-center items-center bg-cover bg-[url("https://cdn.pixabay.com/photo/2016/11/19/22/53/apple-1841553_960_720.jpg")]'>
