...
const Categories = () => {
    return (
        ...
        <div className='flex gap-3 justify-center items-center my-5'>
            <Link><img className='lg:w-48 lg:h-48 w-28 h-28 md:w-36 md:h-36 p-10 border shadow-lg rounded-lg hover:bg-slate-200' src={img1} alt="" /></Link>
            <Link><img className='lg:w-48 lg:h-48 w-28 h-28 md:w-36 md:h-36 p-10 border shadow-lg rounded-lg hover:bg-slate-200'  src={img2}alt="" /></Link>
