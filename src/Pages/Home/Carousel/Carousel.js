...
const Carousel = ({carousel}) => {
    ...
    return (
        ...
        <div className="absolute flex justify-between transform -translate-x-1/2 -translate-y-1/2  left-1/2  top-1/4 lg:my-7">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 -translate-x-1/2 left-1/2 top-1/2 lg:my-0 md:my-2 my-4">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 -translate-x-1/2 left-1/2 top-3/4 my-6 lg:my-0 md:my-0 pb-0 lg:pb-40 md:pb-28">
