...
const SignUp = () => {
    ...
    return (
      ...
      <div className="w-full">
        ...
        <form onSubmit={handleSubmit(handleSignUp)}>
          ...
          <input type="submit" value='SIGNUP' className="input input-bordered w-full bg-primary text-white font-bold mt-3 hover:bg-slate-800"/>
        </form>
    ...
    <img className='xl:w-11/12 w-9/12' src="https://images.pexels.com/photos/4350311/pexels-photo-4350311.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
        </div>
    );
};
